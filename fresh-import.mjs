...
const top250 = [
  ...
  'tt1798709','tt0816692','tt0120382','tt0338013','tt0482571',
  'tt0936557','tt0758758','tt0405094','tt0361748','tt0816692',
  'tt4430212','tt0120735','tt0993846','tt2106476','tt0816692'
]
...
async function run() {
  ...
  console.log(`Importing ${uniqueIds.length} unique movies...\n`)
  ...
  console.log(`\nInserting ${movies.length} movies into Supabase...`)
  ...
  for (let i = 0; i < movies.length; i += 50) {
    ...
    else console.log(`✓ Inserted ${i + 1}–${Math.min(i + 50, movies.length)}`)
  }
